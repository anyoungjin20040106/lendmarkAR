...
var ASM_CONSTS = {
  3244128: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3244189: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3244253: function() {return Module.webglContextAttributes.powerPreference;},  
 3244311: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3244366: function($0) {performance.now = function() { return $0; };},  
 3244414: function($0) {performance.now = function() { return $0; };},  
 3244462: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _DebugImageTarget(id)
      {
          window.iTracker.debugImageTarget(UTF8ToString(id));
      }

  function _DownloadWebGLTexture(img, size, name, ext) {
  ...
  function _GetTrackerFov()
      {
          return window.iTracker.FOV;
      }

  function _GetWebGLCameraFrame(type)
      {
  ...
  function _IsWebGLImageTracked(id)
      {
          return window.iTracker.isImageTracked(id);
      }

  function _IsWebGLTrackerReady()
      {
  ...
  function __gree_unity_webview_destroy(name) {
  		var stringify = (UTF8ToString === undefined) ? Pointer_stringify : UTF8ToString;
  		unityWebView.destroy(stringify(name));
  	}

  function __gree_unity_webview_evaluateJS(name, js) {
  		var stringify = (UTF8ToString === undefined) ? Pointer_stringify : UTF8ToString;
  		unityWebView.evaluateJS(stringify(name), stringify(js));
  	}

  function __gree_unity_webview_init(name) {
  		var stringify = (UTF8ToString === undefined) ? Pointer_stringify : UTF8ToString;
  		unityWebView.init(stringify(name));
  	}

  function __gree_unity_webview_loadURL(name, url) {
  		var stringify = (UTF8ToString === undefined) ? Pointer_stringify : UTF8ToString;
  		unityWebView.loadURL(stringify(name), stringify(url));
  	}

  function __gree_unity_webview_setMargins(name, left, top, right, bottom) {
  		var stringify = (UTF8ToString === undefined) ? Pointer_stringify : UTF8ToString;
  		unityWebView.setMargins(stringify(name), left, top, right, bottom);
  	}

  function __gree_unity_webview_setVisibility(name, visible) {
  		var stringify = (UTF8ToString === undefined) ? Pointer_stringify : UTF8ToString;
...
var asmLibraryArg = {
  "DebugImageTarget": _DebugImageTarget,
  "DownloadWebGLTexture": _DownloadWebGLTexture,
  "GetJSMemoryInfo": _GetJSMemoryInfo,
  "GetTrackerFov": _GetTrackerFov,
  "GetWebGLCameraFrame": _GetWebGLCameraFrame,
  "GetWebGLCameraName": _GetWebGLCameraName,
  "IsWebGLImageTracked": _IsWebGLImageTracked,
  "IsWebGLTrackerReady": _IsWebGLTrackerReady,
  ...
  "PauseWebGLCamera": _PauseWebGLCamera,
  "SetWebGLTrackerSettings": _SetWebGLTrackerSettings,
  "StartWebGLTracker": _StartWebGLTracker,
  "StopWebGLTracker": _StopWebGLTracker,
  "UnpauseWebGLCamera": _UnpauseWebGLCamera,
  ...
  "_gree_unity_webview_destroy": __gree_unity_webview_destroy,
  "_gree_unity_webview_evaluateJS": __gree_unity_webview_evaluateJS,
  "_gree_unity_webview_init": __gree_unity_webview_init,
  "_gree_unity_webview_loadURL": __gree_unity_webview_loadURL,
  "_gree_unity_webview_setMargins": __gree_unity_webview_setMargins,
  "_gree_unity_webview_setVisibility": __gree_unity_webview_setVisibility,
